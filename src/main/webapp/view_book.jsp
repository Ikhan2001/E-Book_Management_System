		...
		<div class="container-fluid p-3 bg-white">
			<div class="row">
				<div class="col-md-6 text-center p-5 border">
					...
					<h4 class="mt-3">Book Name: <span class="text-primary"><%=b.getBookName() %></span></h4>
					<h4>Author Name: <span class="text-primary"><%=b.getAuthor()%></span></h4>
				...
				<div class="col-md-6 text-center p-5 border bg-white">
					...
					<h5 class="text-secondary">Email: <%=b.getEmail() %></h5>
					<% 
					}
					%>
